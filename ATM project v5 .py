...
class ATM:                                                         #yek class ba mohtavaye database va i (shomarande ozviyat Bank)
    ...
    def ozviyat(self):                                 #function ozviyat vase safheye ozviyat hasteshe ke dar dakhel try except neveshte shode ta har gone erorr code dobare be func show() bargarda va code stop nashavd
        try:
            ...
            print("az ATM BALLUK kharej shodid dar vared kardan atelaat khod degtat konid !!! ♥")  #agar erorr shod (masalan karbar be jaye adad harf dad be atm) in jomlaro pront kone va be safheye aval bargarde
            self.show()
    ...
    def show(self):         #function show meno asli bank ro tashkil mide ke tabe function haye ozviyat , exit va meno khadamat dakheleshan 
        ...
        match ozv.upper():            #dar inja az karbar baraye entekhab meno ozviyat ya baraye vorod be bank darkhat midim 
            case "OZV":               #agar ozv vared kard be safhe ozviyat montagel mishe
                self.ozviyat()
            case "EXIT":               #agar exit vared kard az barname kharej mishe
                self.exit()
            case _:                     #agar hich kodam ra vared nakard va enter ya hatchi geyre in balahayi zad be ehsterak sanj vared mishavad
    ...
    def tagir_etelaat(self):   #functio tagir etelaat menno tagir etelat ra miyavarad
        ...
        print("2.exit")                                                            #meno khadamat haye gabel erye chap mishavad
        try:
            while True:
            ...
            print("!!!!!!!!!! lotfan dar vared kardan adad degat konid !!!!!!!!!!")
            self.tagir_etelaat()
    ...
    def mojodi(self):        #func mojodi mojodi ra az db estekhraj va namayesh midahad
        'dont look at me -_-'
        ...
        try:
            while True:                            #dar inja bad chap mojodi karbar ra baraye edame amaliyat rahnomayi mikonim 
                ...
                if gozine != "": 
                    ...
                    print("***field hara khali nagozarid***")
            match gozine:
